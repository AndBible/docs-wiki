...
There are 5 translatable resources in Transifex: `strings.xml`, `BibleNames`, `playstore-description.yml`, `PlayStoreShortText.txt` and `PlayStoreTitleText.txt`.
...
Translation priorities are like this:
 ...
 - `PlayStore*.txt` and `playstore-description.yml` are texts for Google Play Store and F-Droid.  
