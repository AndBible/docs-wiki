...
- [I have older phone, that doesn't have Android 5.0+. Can I use And Bible?](https://github.com/AndBible/and-bible/wiki/FAQ#i-have-older-phone-that-doesnt-have-android-50-can-i-use-and-bible)
...
- [This app used to be great, but now it is total garbage! Why are you doing this?](https://github.com/AndBible/and-bible/wiki/FAQ#this-app-used-to-be-great-but-now-it-is-total-garbage-why-are-you-doing-this)
...
|---|---|---|
| 2.3 (Gingerbread) and newer | 2.9.5 (Not supported) | [Download](https://github.com/AndBible/and-bible/releases/tag/build-02.09.05) |
| 4.4 (KitKat) and newer | 3.2.343 (Not supported) | [Download](https://github.com/AndBible/and-bible/releases/tag/v3.2.343) |
...
to take advantage of our app. For something like 50-100€ you will get more than enough power to run our app (yes, it does not need to be that powerfull). Tablet device is best suited for using And Bible as you will surely appreciate the extra cm²s it provides when studying the Bible with multiple windows. 
 - You could [run the app on Windows 11](https://andbible.readthedocs.io/en/latest/getting_started.html#windows-11-setup) (it runs Android apps)
...
1. From under `Import & Export`, select an earlier backup (file called `dbBackup-33-*.db` (where * is timestamp)) to be exported (it is preserved for 3 months). Back it up somewhere - either on your device or send it to yourself. **Make sure this file has been saved correctly**. 
